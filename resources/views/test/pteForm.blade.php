...
<div class="border border-2 p-3 mt-5" style="margin-left: 28%; margin-right:28%;">
  <div class="d-flex justify-content-center mb-3 fw-bold fs-4"><span class="text-danger">Choose Image For PTE</span></div>
  <hr>
  <form class="p-3" method="post" action="{{route('admin.postPteImagePage')}}" enctype="multipart/form-data" >
    @csrf
    <label class="mb-3 mt-1" for="ieltsimg">Choose a Image</label>
        <div class="input-group mb-3">
        <input type="file" class="form-control" name="pteimg" id="ieltsimg">
        </div>
