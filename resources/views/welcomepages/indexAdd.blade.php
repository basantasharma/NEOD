...
<div class="p-3 mt-5" style="margin-left: 20%; margin-right:20%;">
  ...
  <hr>
  <form class="p-3" method="post" action="{{route('admin.postIndex')}}" >
    @csrf
...
var x=  document.getElementById('page').classList.add("menu-open");
    var xy=  document.getElementById('addindex').classList.add("menu-open","bg-secondary" ,"bg-opacity-25","text-light","rounded");
    console.log(x);
    console.log(xy);
</script>
@endsection